...
public class ProductMasterController {
    ...
    */
    ...
    public String searchProductUsingSize(@PathVariable("styleNumber") String styleNumber,
            @PathVariable("colorCode") String colorCode, @PathVariable("size") String size) {
        LOG.debug("StyleNumber : " + styleNumber + " colorCode : " + colorCode + " Size : " + size);
        return productMasterSearchservice.searchProductSizeByStyleColor(styleNumber, colorCode,
                size);
    }
    ...
    public String searchProductSizes(@PathVariable("styleNumber") String styleNumber,
            @PathVariable("colorCode") String colorCode) {
        LOG.debug("StyleNumber : " + styleNumber + " colorCode : " + colorCode);
        return productMasterSearchservice.searchProductSizesByStyleColor(styleNumber, colorCode);
    }
