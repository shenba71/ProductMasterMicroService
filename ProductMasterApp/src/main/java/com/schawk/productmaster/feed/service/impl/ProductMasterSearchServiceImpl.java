...
@Service
public class ProductMasterSearchServiceImpl implements
	...
	public String searchProductUsingStyleAndColor(String styleNumber,
		...
		try {
			searchResult = productMasterFeedDao.searchFeedByStyleAndColor(
	...
	public String searchProductUsingStyle(String styleNumber, String[] field) {
		String searchResult = null;
		try {
			searchResult = productMasterFeedDao.searchFeedByStyle(styleNumber,
					field);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public String searchProducts(String columnName, String[] columnValues,
		...
		try {
			...
			searchResult = productMasterFeedDao.searchProducts(columnName,
